...
_STAGE_RANGES: dict[str, StagePhysicalRange] = {
    ...
    "first_stars": StagePhysicalRange(
        "first_stars",
        260_000_000.0 * _SECONDS_PER_YEAR,
        450_000_000.0 * _SECONDS_PER_YEAR,
        "логарифмически сжато",
    ),
    "reionization": StagePhysicalRange(
        "reionization",
        450_000_000.0 * _SECONDS_PER_YEAR,
        1_050_000_000.0 * _SECONDS_PER_YEAR,
        "логарифмически сжато",
    ),
}
...
def stage_screen_duration_s(config: UniverseConfig, stage_id: str, fallback: float = 1.0) -> float:
    ...
    durations = {
        ...
        "first_stars": director.first_stars_visual_duration_s,
        "reionization": director.reionization_visual_duration_s,
    }
